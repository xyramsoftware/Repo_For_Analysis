...
describe('Carousel API:', function() {
  ...
  describe('POST /api/carousel', function() {
    ...
    it('should respond with the newly created coupon', function() {
      newCarousel.name.should.equal('New Coupon');
      newCarousel.info.should.equal('This is the brand new coupon!!!');
    });
  });
  ...
  describe('PUT /api/carousel/:id', function() {
    ...
    it('should respond with the updated coupon', function() {
      updatedCarousel.name.should.equal('Updated Coupon');
      updatedCarousel.info.should.equal('This is the updated coupon!!!');
    });
  ...
  describe('PATCH /api/coupons/:id', function() {
    ...
    beforeEach(function(done) {
      request(app)
        .patch(`/api/coupons/${newCarousel._id}`)
        .send([
